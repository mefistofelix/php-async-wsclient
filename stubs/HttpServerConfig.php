...
final class HttpServerConfig
{
     ...
     * with code 1001 (GoingAway).
     *
     * Default: 30000 (30 s). 0 disables automatic ping.
     */
    ...
    /**
     * Pong deadline in milliseconds — how long the server waits after a
     * PING before declaring the connection dead.
     *
     * Default: 60000 (60 s). 0 disables the timeout.
     */
