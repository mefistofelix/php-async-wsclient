 ...
 * Stub hash: 148e00c4084ca2d414b6c54406f4f51df44d4a94 */
...
static zend_class_entry *register_class_TrueAsync_RoomDeliveryException(zend_class_entry *class_entry_TrueAsync_WebSocketException)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "TrueAsync", "RoomDeliveryException", NULL);
	class_entry = zend_register_internal_class_with_flags(&ce, class_entry_TrueAsync_WebSocketException, ZEND_ACC_FINAL|ZEND_ACC_NO_DYNAMIC_PROPERTIES);
