...
#define PHP_HTTP_SERVER_VERSION "0.10.1"
...
static inline uint32_t http_server_get_tls_buffer_bytes(const http_server_object *server) {
    return http_server_view(server)->tls_buffer_bytes;
}
